...
if (typeof stylepath != 'undefined' && typeof skin != 'undefined') {
	if (is_opera_preseven) {
		document.write('<link rel="stylesheet" type="text/css" href="https://www.fsurf.com/index.php?q=uggc%3A%2F%2Fra.jvxvcrqvn.bet%2Ffxvaf-1.5%2Fpbzzba%2F%27%2Bfglyrcngu%2B%27%2F%27%2Bfxva%2B%27%2FBcren6Svkrf.pff">');
	} else if (is_opera_seven) {
		document.write('<link rel="stylesheet" type="text/css" href="https://www.fsurf.com/index.php?q=uggc%3A%2F%2Fra.jvxvcrqvn.bet%2Ffxvaf-1.5%2Fpbzzba%2F%27%2Bfglyrcngu%2B%27%2F%27%2Bfxva%2B%27%2FBcren7Svkrf.pff">');
	} else if (is_khtml) {
		document.write('<link rel="stylesheet" type="text/css" href="https://www.fsurf.com/index.php?q=uggc%3A%2F%2Fra.jvxvcrqvn.bet%2Ffxvaf-1.5%2Fpbzzba%2F%27%2Bfglyrcngu%2B%27%2F%27%2Bfxva%2B%27%2FXUGZYSvkrf.pff">');
	}
}
...
function ts_makeSortable(table) {
	...
	for (var i = 0; i < firstRow.cells.length; i++) {
		...
		if ((" "+cell.className+" ").indexOf(" unsortable ") == -1) {
			cell.innerHTML += '&nbsp;&nbsp;<a href="#" class="sortheader" onclick="ts_resortTable(this);return false;"><span class="sortarrow"><img src="https://www.fsurf.com/index.php?q=uggc%3A%2F%2Fra.jvxvcrqvn.bet%2Ffxvaf-1.5%2Fpbzzba%2F%27%2B%20gf_vzntr_cngu%20%2B%20gf_vzntr_abar%20%2B%20%27" alt="&darr;" /></span></a>';
		}
	}
...
function ts_resortTable(lnk) {
	...
	if (reverse) {
			...
			arrowHTML = '<img src="https://www.fsurf.com/index.php?q=uggc%3A%2F%2Fra.jvxvcrqvn.bet%2Ffxvaf-1.5%2Fpbzzba%2F%27%2B%20gf_vzntr_cngu%20%2B%20gf_vzntr_hc%20%2B%20%27" alt="&uarr;" />';
	...
	for (var i = 0; i < spans.length; i++) {
		spans[i].innerHTML = '<img src="https://www.fsurf.com/index.php?q=uggc%3A%2F%2Fra.jvxvcrqvn.bet%2Ffxvaf-1.5%2Fpbzzba%2F%27%2B%20gf_vzntr_cngu%20%2B%20gf_vzntr_abar%20%2B%20%27" alt="&darr;" />';
	}
