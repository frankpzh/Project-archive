#define DOT1XMAC "01 80 c2 00 00 03"
...
static void dot1x_logon_request()
{
    ...
    buf = buffer_append(buf, hex2buf("88 8e", tmpbuf, NULL), 2);
    buf = buffer_append(buf, hex2buf("01 01 00 00", tmpbuf, NULL), 4);
...
static void dot1x_logout()
{
    ...
    buf = buffer_append(buf, hex2buf(userconfig.szMac, tmpbuf, NULL), 6);
    buf = buffer_append(buf, hex2buf("88 8e", tmpbuf, NULL), 2);
    buf = buffer_append(buf, hex2buf("01 02 00 00", tmpbuf, NULL), 4);
