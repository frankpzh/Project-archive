...
BOOL socket_fetch_DWORD(SOCKET sock, BUFFER *buf, BYTE **ptr, DWORD *d);
BOOL socket_fetch_BYTE(SOCKET sock, BUFFER *buf, BYTE **ptr, BYTE *b);
BOOL socket_fetch_STRING(SOCKET sock, BUFFER *buf, BYTE **ptr, STRING **pstr, INT len);
BOOL socket_fetch_bytes(SOCKET sock, BUFFER *buf, BYTE **ptr, BYTE *bytes, INT len);
BOOL socket_fetch_byte_a_while(SOCKET sock, BUFFER *buf, BYTE **ptr, BYTE *b);
...
INT os_socket_tcp_recv_nonblock(SOCKET s, BYTE *buf, UINT size);
